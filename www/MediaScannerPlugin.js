...
module.exports = {
    ...
    scanFiles:function(successCallback, failureCallback) {
        ...
        if (typeof successCallback !== "function") {
            ...
            return cordova.exec(successCallback, failureCallback, "MediaScannerPlugin", "scanFiles", []);
        }
    },

    scanFile:function(targetFile, successCallback, failureCallback) {
        // successCallback required
        if (typeof successCallback !== "function") {
            console.log("MediaScannerPlugin Error: successCallback is not a function");
        }
            ...
            return cordova.exec(successCallback, failureCallback, "MediaScannerPlugin", "scanFile", [targetFile]);
        }
    }
